...
import {  signup, signin, logout, updateAccessToken,  updateUserInfo, updatePassword } from "../../controllers/userController";
...
// Route for activating a user's account not used in this qp assesment
